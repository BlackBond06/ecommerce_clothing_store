...
const FeaturedProducts = ({ type }) => {
  ...
  const fetchImageFromApi = async ()=>{
    ...
    try {
      setLoading(true)
      const response = await api.search.getPhotos({ query: "fashion", perPage: 6, orientation: "landscape" });
      ...
      <Stack margin={{ base: "50px 25px 10px 25px", md:"70px 100px 10px 100px", lg: "100px 200px" }}>
        ...
        >
          ...
          <Text textAlign="justify" flex={3}>
            Whether you're in the market for a new wardrobe or just looking for
            some inspiration, our featured section is the ultimate destination
