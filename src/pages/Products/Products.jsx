  ...
  return (
    <motion.div variants={routerVariants} initial="initial" animate="final">
      <Flex
        ...
        padding={{ base: "unset", md: "unset", lg: "30px 50px" }}
      >
        <Flex
          direction="column"
          flex={1}
        ...
        >
          ...
          <Box marginBottom="30px">
            <Heading fontSize="14px" marginBottom="20px" marginTop="20px">
              Filter by price
            </Heading>
        ...
        <Flex direction="column" flex={3}>
          <Box height="300px" marginBottom="50px">
            {loading ? (
              ...
              <Image
                src="https://images.unsplash.com/photo-1627384113972-f4c0392fe5aa?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTJ8fHByb2R1Y3RzfGVufDB8MHwwfHw%3D&auto=format&fit=crop&w=500&q=60"
                height="100%"
                width="100%"
                objectFit="cover"
                alt="products' banner"
